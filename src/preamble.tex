...
\usepackage[backend=biber, style = numeric, url=false, isbn = false]{biblatex}%, {, }]{biblatex}
\addbibresource{refs_main.bib}
\usepackage{color}
\usepackage{hyperref}
...
\definecolor{bluemv}{HTML}{2a67bd}
\definecolor{darkbluemv}{HTML}{064789}
\definecolor{lightbluemv}{HTML}{80DEEA}
\definecolor{magentamv}{HTML}{EC407A}
\definecolor{greenmv}{HTML}{00796B}


\hypersetup{colorlinks, citecolor=bluemv, linkcolor=bluemv, urlcolor=magentamv, linktocpage=true}