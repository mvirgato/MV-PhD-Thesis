...
\usepackage[backend=biber, style = numeric, url=false, isbn = false, sorting=none, citestyle=numeric-comp, defernumbers=true]{biblatex} 
\renewcommand{\bibfont}{\normalfont\footnotesize}
\addbibresource{src/references_zotero.bib}
...
\usepackage[toc=false,nonumberlist,nopostdot,abbreviations,automake,section=section]{glossaries-extra}
...
\definecolor{lightgraymv}{HTML}{6b6969}

\hypersetup{colorlinks, citecolor=lightgraymv, linkcolor=lightgraymv, urlcolor=lightgraymv, linktocpage=lightgraymv}
