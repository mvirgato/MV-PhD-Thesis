...
\subsubsection*{WIMPs}
 Weakly Interacting Massive Particles (WIMPs) are a class of dark matter candidates that 
 These particles arose naturally in many extensions of the SM that 

 The most common class of WIMPs are ``thermal WIMPs" that were at one point in thermal equilibrium with the Standard Model bath. 

As the Universe expands and the temperature drops, the interactions that keep the WIMP in thermal equilibrium with the bath slow down. Eventually, the interactions will freeze out once they occur at a slower rate than that of the expansion. Once this occurs, the WIMPs can no longer efficiently annihilate and their abundance becomes ``frozen in" to the value we observe today. 
