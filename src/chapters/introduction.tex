...
\begin{figure}[t!]
    ...
    \caption[Illustrative landscape of dark matter models and the mass range for which they predict a valid candidate.]{Illustrative landscape of dark matter models and the mass range for which they predict a valid candidate. Details can be found in the Dark Matter chapter of the PDG~\cite{ParticleDataGroup:2022pth_aug_ReviewParticlePhysics}.}
