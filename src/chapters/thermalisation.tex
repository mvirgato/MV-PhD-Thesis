...
In this chapter, we have studied the thermalisation and annihilation of dark matter that has been captured within a neutron star. We gave detailed calculations for the time timescales involved in these processes that include: a) the time required for the dark matter to deposit 99\% of its kinetic energy through scattering processes, $\tkin$; b) the time required for dark matter to reach thermalistion within the core of the star, $\tth$; and c) the timescale in which capture-annihilation equilibrium is achieved, $\teq$.
...
Perhaps the most important result is that these results are obtained without requiring that the DM has fully thermalised within the star. This was achieved by taking into account the lowest temperature the DM had time to reach within the lifetime of the star. This is especially important for interactions that have scattering cross-sections suppressed are momentum suppressed in the non-relativistic limit, and in particular operators D2 and D4. 

The thermalisation times for these operators exceed the age of the Universe for a large portion of the parameter space, hence would not have been thought to be able to heat the star through annihilations. This enables future NS observations to provide a potential probe of interactions for which conventional direct detection experiments are insensitive to.